...
const StoryPage = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.sectionTitle}>Лидерство</Text>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.sectionTitle}>Активность на ивентах</Text>
      ...
      <View style={styles.sectionContainer}>
        <Text style={styles.sectionTitle}>Менторские часы</Text>
